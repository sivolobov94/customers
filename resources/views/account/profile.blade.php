                                    ...
                                    <form method="POST" action="{{route('post-edit-profile')}}">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="description" rows="5" class="form-control-plaintext"
                                                              placeholder="">
                                                                {{$profile->description}}
                                                            </textarea>
                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label>Сайт</label>
                                                    <input value="{{$profile->site}}" readonly name="site" type="text"
                                                           class="form-control-plaintext" placeholder="">
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input value="{{$profile->category}}" readonly name="site"
                                                           type="text" class="form-control-plaintext" placeholder="">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input value="{{$profile->r_fullname}}" readonly name="r_fullname"
                                                           type="text" class="form-control-plaintext" placeholder="">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input value="{{$profile->r_director}}" readonly name="r_director"
                                                           type="text" class="form-control-plaintext" placeholder="">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input {{$profile->r_chief_accountant}} readonly name="r_chief_accountant" type="text"
                                                           class="form-control-plaintext" placeholder="">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label>Факс</label>
                                                    <input value="{{$profile->r_fax}}" readonly name="r_fax" type="text"
                                                           class="form-control-plaintext" placeholder="">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label>ИНН</label>
                                                    <input value="{{$profile->r_INN}}" readonly name="r_INN" type="text"
                                                           class="form-control-plaintext" placeholder="">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label>КПП</label>
                                                    <input value="{{$profile->r_KPP}}" readonly name="r_KPP" type="text"
                                                           class="form-control-plaintext" placeholder="">
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label>ОГРН</label>
                                                        <input value="{{$profile->r_OGRN}}" name="r_OGRN" readonly type="text"
                                                               class="form-control-plaintext" placeholder="">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label>% кэшбэка</label>
                                                        <input value="{{$profile->r_cashback}}" readonly name="r_cashback"
                                                               type="text" class="form-control-plaintext"
                                                               placeholder="">
                                                    </div>
                                                </div>
